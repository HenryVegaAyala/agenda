...
$this->title = 'Sistema Ticket - Lista de Técnicos';
?>
            ...
            <div class="table table-striped table-responsive jambo_table bulk_action">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?= "Sistema Ticket - Lista de Técnicos" ?></h3>
                    </div>
                    <p class="note"></p>
                                    ...
                                    'buttons' => [
                                        'view' => function ($url, $model) {
                                            return Html::a('<i class="fa fa-eye fa-lg-icon" aria-hidden="true"></i>',
                                                Yii::$app->urlManager->createUrl(['ver-tecnico/' . $model->id]),
                                                [
                                        ...
                                        'update' => function ($url, $model) {
                                            return Html::a('<span class="fa fa-pencil-square-o fa-lg-icon"></span>',
                                                Yii::$app->urlManager->createUrl(['actualizar-tecnico/' . $model->id]),
